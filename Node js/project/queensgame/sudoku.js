...
function starttimer(){
    ...
    myinterval=setInterval(()=>{
        ...
        text=document.createTextNode(`${minute1}:${second1}`)
...
class checkvalue{ 
    ...
    function handleClick (event) {
        ...
        if(box.className=='box'){
            ...
            if(checkstatus)
                ...
                box.style.backgroundColor = "#ff0000a1";
                setTimeout(() => {
    ...
    function resetGame(){
        ...
        function solve()
        {
            ...
            let queen=document.getElementById('container1')
            let hint1 = document.getElementById('hint')
            hint1.removeEventListener('click',hint)
            queen.removeEventListener('click',handleClick)
            reset1=document.getElementById('reset')
            reset1.removeEventListener('click',resetGame)
            clearInterval(myinterval)
        }
